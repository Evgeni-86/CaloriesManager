...
public class MealController {
    ...
    public String getAllMeals(Model model) {
        ...
        List<Meal> mealsDateFiltered = mealService.getBetweenDates(DateTimeUtil.MIN_DATE, DateTimeUtil.MAX_DATE, zoneId, userId);
    ...
    public String filter(@RequestParam("startDate") String startDate,
        ...
        List<Meal> mealsDateFiltered = mealService.getBetweenDates(startD, endD, zoneId, userId);
    ...
    @RequestMapping("/edit")
    public String editMeal(@Valid @ModelAttribute("meal") MealViewModel mealViewModel, BindingResult bindingResult) {
